...
//update all users by role from admin to manager 
// craete a function to update all users by role from admin to manager
...
module.exports= {updateAllUsersByRole,updateUserByID,getallUsers,createNewUser,findUserByRole,deleteUserByID};
